...
<body class="homepage">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#" aria-haspopup="true"
    ...
    <section id="billboard" class="bg-light"
        ...
        <!-- Overlay Hitam dengan 20% opacity -->
        <div
            style="
    ...
    <section id="new-arrival" class="new-arrival product-carousel position-relative overflow-hidden pb-5">
        <div class="container">
            ...
            <div class="row d-flex flex-wrap justify-content-between py-5">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu footer-menu-004 border-animation-left">
                        ...
                        <p>
                            Atau whatsapp ke no
                            <a href="tel:+43 720 11 52 78" class="item-anchor">08123456789</a>
                        </p>
                    </div>
                </div>
            </div>
